...
// generatedHelpTargets are targets generated by make-help that should be
// excluded from mixed categorization validation (they'll be regenerated anyway).
var generatedHelpTargets = map[string]bool{
	"help":        true,
	"update-help": true,
}
...
// - Generated help targets (help, update-help) are excluded from this check
func ValidateCategorization(model *HelpModel, defaultCategory string) error {
	...
	// Exclude generated help targets from this check
	categorizedCount := 0
